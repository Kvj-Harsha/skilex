...
const profiles = [
  { name: 'John Doe', email: 'john@example.com', city: 'Mumbai', state: 'Maharashtra', avatar: '/john.png', rating: 6.5, skills: 'Android Developer' },
  { name: 'Jane Smith', email: 'jane@example.com', city: 'Hyderabad', state: 'Telangana', avatar: '/jane.png', rating: 7.2, skills: 'IOS Developer' },
  { name: 'Michael Johnson', email: 'michael@example.com', city: 'Vijayawada', state: 'Andhra Pradesh', avatar: '/michael.png', rating: 8.9, skills: 'Cross-platform developer' },
  { name: 'John Doe', email: 'john@example.com', city: 'Kolkata', state: 'West Bengal', avatar: '/john.png', rating: 7.8, skills: 'WearOS Developer' },
  { name: 'Jane Smith', email: 'jane@example.com', city: 'Kolkata', state: 'West Bengal', avatar: '/jane.png', rating: 9.1, skills: 'UI/UX + deployment' },
  { name: 'Michael Johnson', email: 'michael@example.com', city: 'Chennai', state: 'Tamil Nadu', avatar: '/michael.png', rating: 6.7, skills: 'Android Developer' },
  { name: 'John Doe', email: 'john@example.com', city: 'Bangalore', state: 'Karnataka', avatar: '/john.png', rating: 8.4, skills: 'IOS Developer' },
  { name: 'Jane Smith', email: 'jane@example.com', city: 'Raichur', state: 'Karnataka', avatar: '/jane.png', rating: 6.9, skills: 'Cross-platform developer' },
  { name: 'Michael Johnson', email: 'michael@example.com', city: 'Hyderabad', state: 'Telangana', avatar: '/michael.png', rating: 7.5, skills: 'WearOS Developer' },
