...
const profiles = [
  { name: 'John Doe', email: 'john@example.com', city: 'Mumbai', state: 'Maharashtra', avatar: '/john.png', rating: 6.5, skills: 'PS editor' },
  { name: 'Jane Smith', email: 'jane@example.com', city: 'Hyderabad', state: 'Telangana', avatar: '/jane.png', rating: 7.2, skills: 'Adobe illustrator' },
  { name: 'Michael Johnson', email: 'michael@example.com', city: 'Vijayawada', state: 'Andhra Pradesh', avatar: '/michael.png', rating: 8.9, skills: 'canva' },
  { name: 'John Doe', email: 'john@example.com', city: 'Kolkata', state: 'West Bengal', avatar: '/john.png', rating: 7.8, skills: 'canva' },
  { name: 'Jane Smith', email: 'jane@example.com', city: 'Kolkata', state: 'West Bengal', avatar: '/jane.png', rating: 9.1, skills: 'PS' },
  { name: 'Michael Johnson', email: 'michael@example.com', city: 'Chennai', state: 'Tamil Nadu', avatar: '/michael.png', rating: 6.7, skills: 'GIMP' },
  { name: 'John Doe', email: 'john@example.com', city: 'Bangalore', state: 'Karnataka', avatar: '/john.png', rating: 8.4, skills: 'Paint' },
  { name: 'Jane Smith', email: 'jane@example.com', city: 'Raichur', state: 'Karnataka', avatar: '/jane.png', rating: 6.9, skills: 'AI' },
  { name: 'Michael Johnson', email: 'michael@example.com', city: 'Hyderabad', state: 'Telangana', avatar: '/michael.png', rating: 7.5, skills: 'AI' },
